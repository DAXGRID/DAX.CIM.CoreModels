...
{
    [TestClass]
    public class TestStationHopFeederInfoFullNet : FixtureBase
    {
        CimContext _context;
        ...
        {
            var reader = new CimJsonFileReader(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"C:\temp\cim\complete_net.jsonl"));
